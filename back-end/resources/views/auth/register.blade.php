            ...
            <div class="landing-downlay bg-primary h-100 d-flex flex-column justify-content-end align-items-center">
                ...
                <div class="landing-downlay bg-white h-90 w-100 p-3 overflow-auto">
                    ...
                    <form class="mb-5" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group mb-3">
                            <label for="password-confirm" class="span ms-3 mb-1"> Password Confirm</label>
                            <input type="password" name="password_confirmation" id="password-confirm" placeholder="********"
                                required class="form-control w-100 mb-1" />
                        </div>
                        <button type="submit" class="btn btn-primary text-white w-100 mb-3 py-2">
                            Register
                        </button>
                    </form>
